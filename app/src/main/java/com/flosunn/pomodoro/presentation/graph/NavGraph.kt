...
import com.flosunn.pomodoro.presentation.goals.add_goal.AddGoalView
import com.flosunn.pomodoro.presentation.goals.update_goal.UpdateGoalView
...
import com.flosunn.pomodoro.presentation.week_year.add_new_year.AddNewYearView
...
import com.flosunn.pomodoro.presentation.week_year.twelve_week_year.TwelveWeekYearView
import com.flosunn.pomodoro.presentation.week_year.week_detail.WeekDetailView
import com.flosunn.pomodoro.presentation.week_year.year_detail.YearDetailView
    ...
    NavDisplay(
        ...
        entryProvider = { key ->
            when (key) {
                ...
                is NavRoute.WeekDetail -> NavEntry(key) { WeekDetailView(navBackStack) }
