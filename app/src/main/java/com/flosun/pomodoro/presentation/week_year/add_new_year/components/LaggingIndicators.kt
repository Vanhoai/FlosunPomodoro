...
fun LaggingIndicators(
    laggingIndicators: List<Pair<String, String>>, // Pair<Uuid, Name>
    onAddLaggingIndicator: (String) -> Unit, // Name
    onDeleteLaggingIndicator: (String) -> Unit, // Uuid
    onUpdateLaggingIndicator: (String, String) -> Unit, // Uuid, Updated Name
) {
    ...
    var selectedLaggingIndicatorUuid by remember { mutableStateOf<String?>(null) }
            ...
            SwipeableCard(
                ...
                actions = listOf(
                    SwipeableAction(
                        ...
                        onPress = {
                            laggingIndicatorName = indicator.second
                            isShowBottomSheet = true
                            currentAction = BottomSheetAction.UPDATE
                            selectedLaggingIndicatorUuid = indicator.first
                            scope.launch { addLaggingIndicatorSheetState.show() }
                        }
                    ),
                    SwipeableAction(
                        ...
                        onPress = { onDeleteLaggingIndicator(indicator.first) }
                    ),
                )
            ) {
                IndicatorCard(indicator.second)
            }
        }
    }
        ...
        TwoOptionActions(
            ...
            onOk = {
                ...
                if (currentAction == BottomSheetAction.ADD) {
                    ...
                    val uuid = selectedLaggingIndicatorUuid ?: return@TwoOptionActions
                    onUpdateLaggingIndicator(uuid, laggingIndicatorName)
                }
